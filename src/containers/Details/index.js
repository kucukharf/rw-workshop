    ...
    render() {
        if (this.props.works.current) {
            ...
            <div className="fadeInUp">
                ...
                <div className={this.props.works.current.theme ? "client-overview client-overview--dark" : "client-overview"} style={{background: this.props.works.current.brandColor}}>
                    <section className="container">
                        <div className="col-7-of-12 overview">
                            <h3>Overview</h3>
                            <p>
                                {this.props.works.current.overview}
                            </p>
                        </div>
                        ...
                        <div className="col-4-of-12 details">
                            ...
                            <ul>
                                ...
                                <li>
                                    <span>Website</span>
                                    <a
                                        href={this.props.works.current.website}
                                        target="_blank">
                                ...
                                <li>
                                    <span>App Store</span>
                                    {this.props.works.current.appstore ? <a
                                ...
                                <li>
                                    ...
                                    {this.props.works.current.playstore ? <a
                    ...
                    <div>
                        ...
                        <section className="container">
                            <div className="client-quote">
                                <blockquote>
                                    {this.props.works.current.spotTitle}{" "}
                                </blockquote>
                            </div>
                        </section>
                        ...
                        <section className="container">
                            <div className="client-quote">
                                <blockquote>
                                   {this.props.works.current.spotDesc}
                                </blockquote>
                            </div>
                        </section>
                    </div>
